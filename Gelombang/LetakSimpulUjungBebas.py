...
class LetakSimpulUjungBebas(MovingCameraScene):
    def construct(self):
        ...
        #Perut Legend
        perut_list = BulletedList(r"Simpul pertama = $\frac{1}{4} \lambda$ ",
                                  r"Simpul kedua = $3 \times \frac{1}{4} \lambda = \frac{3}{4} \lambda$",
                                  r"Simpul ketiga = $5 \times \frac{1}{4} \lambda = \frac{5}{4} \lambda$",
                                  r"Simpul keempat = $7 \times \frac{1}{4} \lambda = \frac{7}{4} \lambda$",

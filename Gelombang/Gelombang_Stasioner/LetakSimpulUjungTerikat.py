...
class LetakSimpulUjungTerikat(MovingCameraScene):
    def construct(self):
        ...
        #Perut Legend
        perut_list = BulletedList(r"Simpul pertama = 0",
                                  r"Simpul kedua = $2 \times \frac{1}{4} \lambda = \frac{2}{4} \lambda =\frac{1}{2} \lambda$",
                                  r"Simpul ketiga = $4 \times \frac{1}{4} \lambda = \frac{4}{4} \lambda =\lambda$",
                                  r"Simpul keempat = $6 \times \frac{1}{4} \lambda = \frac{6}{4} \lambda = 1 \frac{1}{2} \lambda$",
